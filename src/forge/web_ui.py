...
from forge.agent import AgentLoop, AgentRunControl, AgentState, SessionContext, TaskMode
from forge.config import ConfigurationError, ForgeConfig, SUPPORTED_REASONING_EFFORTS
from forge.execution import CommandExecutor
from forge.llm import ModelCommunicationError, OpenAIChatCompletionsClient, OpenAIResponsesClient
...
from forge.trace import TraceRecorder, sanitize_for_storage
...
class BrowserAgentController:
    ...
    def tree(self) -> dict[str, Any]:
        ...
        ignored = {
            ".git", ".forge", ".venv", "__pycache__", "node_modules",
...
def main(argv: list[str] | None = None) -> int:
    """Standalone ``forge-web`` entry point for the local browser interface."""
